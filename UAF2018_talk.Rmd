...
par(mfrow=c(1,2), mai=c(0.7,0.7,0.1,0.1), omi=rep(0,4), lwd=2, fg="black")

## PCA
biplot(prcomp(rock[,c(1,2,4)]), col=c("black", "darkorange"),
       yaxt="n", xaxt="n", ylab="", xlab="")
mtext(side=1, "PC1", cex=1.5, line=1)
mtext(side=2, "PC2", cex=1.5, line=1)

# par(mfrow=c(1,2), mai=c(0.7,0.7,0,0), omi=rep(0,4), lwd=2)
...
mtext(side=1, "NMDS1", cex=1.5, line=1)
mtext(side=2, "NMDS2", cex=1.5, line=1)
```
