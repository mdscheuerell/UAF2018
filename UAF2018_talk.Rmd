...
.blue-text[
## 50% of salmon populations in the continental US are listed under the Endangered Species Act
]
...
plot(seq(20), x1, type="n", pch=16, las=1, 
        xlab="", ylab="", cex.axis=1.5)
mtext(side=1, "Time", line=3.5, cex=1.8)
mtext(side=2, "Sales index", line=3, cex=1.8)

lines(seq(20), x2, type="o", pch=16, cex=1.2, las=1, col="dodgerblue", lwd=2)
```

---

# The .orange-text[onset] of advertising
...
text(tstar,par()$usr[3]-aB, "T",
	 cex=1.7, col="darkorange", pos=1, xpd=TRUE)
```
...
arrows(tstar+1, x1[tstar+1], tstar+1, x2[tstar+1]*0.985,
       length=0.1, col="darkorange", lty="solid", lwd=2)

text(tstar+1.5, (x1[tstar+1]+x2[tstar+1])/1.8, "A",
	 cex=1.7, col="darkorange", adj=c(0.5,0.5))

lines(seq(20), x1, type="o", pch=16, cex=1.2, las=1, col="darkgray", lwd=2)
lines(seq(20), x2, type="o", pch=16, cex=1.2, las=1, col="dodgerblue", lwd=2)
...
text(tstar,par()$usr[3]-aB, "T",
	 cex=1.7, col="darkgray", pos=1, xpd=TRUE)
```
...
## .blue-text[Sales]<sub><i>t</i></sub> = .blue-text[Sales]<sub><i>t</i>-1</sub> + .orange-text[Advertising × I]<sub><i>t</i></sub> + .red-text[error]<sub><i>t</i></sub>
...
## .blue-text[Density]<sub><i>t</i></sub> = .blue-text[Density]<sub><i>t</i>-1</sub> + .orange-text[Supplementation × I]<sub><i>t</i></sub> + .red-text[error]<sub><i>t</i></sub>
...
.blue-text.center[
### Probability of positive effect is ~0.7
]
...
.blue-text[
## Trying to understand when & why stocks covary
]
...
.blue-text[
## Can we detect common trends in the data?
]

.right[
### An example of Alaskan king salmon (15 popns, 25+ years)
]
...
.blue-text[
## Can we detect common spatial patterns in the data?
]

.right[
### An example of California Current rockfish (20 spp, 10 years)
]
...
.right[
### An example of Bering Sea groundfishes (10 spp, 30+ years)
]
