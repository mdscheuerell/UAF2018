...
.blue-text.right[
## A way to map many variables onto few proxies
]

---

```{r plot_many_ts, echo=FALSE, dpi=300, fig.height=6, fig.width=6, fig.align='center', out.height="80%", out.width="80%"}
NN <- 25
TT <- 30
MM <- 3
...
```{r plot_dfa_trends, echo=FALSE, fig.align="center", dpi=300, out.height="80%", out.width="80%"}
## plot the trends
par(mfrow=c(3,3), mai=c(0.1,0.1,0,0), omi=c(1,1,1,1))
