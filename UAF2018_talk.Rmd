...
## .blue-text[State model]

## Density<sub><i>t</i></sub> = Density<sub><i>t</i>-1</sub> + Indicator<sub><i>t</i></sub> + error<sub><i>t</i></sub>

## .purple-text[Observation model]

## Data<sub><i>t</i></sub> = Density<sub><i>t</i></sub> + error<sub><i>t</i></sub>
...
## .blue-text[Density]<sub><i>t</i></sub> = .blue-text[Density]<sub><i>t</i>-1</sub> + .orange-text[Indicator]<sub><i>t</i></sub> + .red-text[error]<sub><i>t</i></sub>
