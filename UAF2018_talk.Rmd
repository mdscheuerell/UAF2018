...
plot.ts(x1, type="n", pch=16, las=1, 
        xlab="", ylab="", cex.axis=1.3)
mtext(side=1, "Time", line=3, cex=1.5)
mtext(side=2, "Sales index", line=3, cex=1.5)

segments(tstar+1, x1[tstar+1], tstar+1, x2[tstar+1], col="darkorange", lty="dashed", lwd=2)

text(tstar+1, (x1[tstar+1]+x2[tstar+1])/2, expression(italic(S)),
	 cex=1.7, col="darkorange", adj=c(-0.1,0))

lines(seq(20), x1, type="o", pch=16, cex=1.2, las=1, col="darkgray", lwd=2)
lines(seq(20), x2, type="o", pch=16, cex=1.2, las=1, col="darkblue", lwd=2)
