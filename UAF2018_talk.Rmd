...
```{r, echo=FALSE, dpi=300, fig.height=4.5, fig.width=8, out.height="100%", out.width="100%", fig.align='center'}
tstar <- 11
...
arrows(x0=tstar,y0=par()$usr[3]-aB,y1=par()$usr[3],
       length=0.1, col="red", xpd=TRUE, lwd=2)
...
.blue-text.center[
### Probability of positive effect $\small \approx$ 0.7
]
...
.orange-text[
## Common year effects overshadow intervention
]
...
.left.blue-text[https://github.com/mdscheuerell/UAF2018]
