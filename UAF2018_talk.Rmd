...
### .blue-text[ Daniel Schindler, Ray Hilborn ] (Univ Washington)
...
## .green-text[ biological (food web interactions, harvest) ]
## .blue-text[ physical (climate, habitat modification) ]
## .orange-text[ chemical (ocean acidification, contaminants) ]

---

# The services can be

## .green-text[ provisioning (food production) ]
## .blue-text[ supporting (nutrient cycling) ]
## .orange-text[ regulating (flood control) ]
## .purple-text[ cultural (spiritual benefits) ]
...
## Estimating food-web interactions
...
.blue-text[
## Hierarchical models are great for analyses of temporal & spatial data

## But, they are _not_ a panacea 
]
